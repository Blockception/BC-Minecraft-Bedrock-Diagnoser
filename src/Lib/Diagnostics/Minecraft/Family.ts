...
export function minecraft_family_diagnose(value: Types.OffsetWord, diagnoser: DiagnosticsBuilder): boolean {
  ...
  //Project has defined
  data.BehaviorPacks.entities.forEach(entity=>{if (entity.families.includes(id)) out = true;});
